...
<?php $query = "SELECT * FROM blogg inner join users on post_author = id WHERE post_category = '1' order by post_date desc";
...
if ($result = mysqli_query($con, $query)) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
     ...
     <h5><a href="post.php?id=<?php echo $row['post_id'];?>">
     
      <?php
if (!empty($row['post_image'])) {
  ?>
  <img src="bilder/post_bilder/<?php echo $row['post_image'];?>" name="" class="usrimagetmb">&nbsp; &nbsp;
  <?php
}
	...
	<img src="bilder/rand_bilder/<?php echo rand(1,8);?>.gif" name="" class="usrimagetmb">&nbsp; &nbsp;
...
?>
	 ...
	 <?php echo $row['post_headline'];?></a> | PUBLICERAD av <a href="profil.php?id=<?php echo $row['id'];?>"><?php echo $row['firstname'];?> <?php echo $row['lastname'];?></a> <?php echo $row['post_date'];?></h5>
