...
<div class="maincontent">
  ...
  <div class="normalcontent">
 	...
 	<h1>Film / TV-tips</h1><hr>
    
    <p><input type="search" class="menuinputfield"> &nbsp;<img src="bilder/sidbilder/icons/smallicons/search.gif" width="26" height="40" alt=""/>
    (UNDER KONSTRUKTION)</p><hr>
 

<?php $query = "SELECT * FROM blogg inner join users on post_author = id WHERE post_category = '3' order by post_date desc";
...
if ($result = mysqli_query($con, $query)) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
     ...
     <h5><a href="post.php?id=<?php echo $row['post_id'];?>"><?php echo $row['post_headline'];?></a> | PUBLICERAD av <a href="profil.php?id=<?php echo $row['id'];?>"><?php echo $row['firstname'];?> <?php echo $row['lastname'];?></a> <?php echo $row['post_date'];?></h5>
