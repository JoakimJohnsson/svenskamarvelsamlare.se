...
<div class="maincontent">
  ...
  <div class="normalcontent">
    ...
    <p>Här hittar du information om alla utgivare och förlag som publicerat Marvelserier i Sverige och utomlands. </p>
   ...
   <h2>Utgivare / förlag som har publicerat marvelserier i Sverige</h2><hr>
   ...
   <?php $query = "SELECT * FROM publisher WHERE publisher_country = 'sverige' order by publisher_name asc";
        ...
        <p class="usrimagebkg" style="text-align: center;"><a href="publisher.php?id=<?php echo $row['publisher_id'];?>"> 
		<img src="bilder/publisher_bilder/<?php echo $row['publisher_image'];?>" name="Logotyp" class="publisherimagetmb"> <br>
